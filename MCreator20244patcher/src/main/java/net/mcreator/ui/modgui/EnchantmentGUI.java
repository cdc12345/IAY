...
public class EnchantmentGUI extends ModElementGUI<Enchantment> {
    ...
    private final JSpinner damageBonus = new JSpinner(new SpinnerNumberModel(0, 0, 1024, 1));
    ...
    @Override protected void initGUI() {
        ...
        JPanel selp = new JPanel(new GridLayout(13, 2, 50, 2));
    ...
    @Override public void openInEditingMode(Enchantment enchantment) {
        ...
        damageBonus.setValue(enchantment.damageBonus);
    }
    ...
    @Override public Enchantment getElementFromGUI() {
        ...
        enchantment.damageBonus = (int)damageBonus.getValue();
