...
public class ProcedureTest {
    ...
    @Test
    public void testLangFileExist() throws IOException {
        File lang = new File("src\\main\\resources\\lang\\texts.properties");
        if (!lang.exists()){
            throw new FileNotFoundException("texts.properties");
        }
    }
